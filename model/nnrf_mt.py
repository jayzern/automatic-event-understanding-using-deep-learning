...
class MTRF(GenericModel):
    ...
    def __init__(self, n_word_vocab=50001, n_role_vocab=7, n_factors_emb=300, n_hidden=300, word_vocabulary={}, role_vocabulary={}, 
        ...
        embedding_layer = role_based_word_embedding(input_words, input_roles, n_word_vocab, n_role_vocab, GlorotUniform(), 
        ...
        event_embedding = Lambda(lambda x: tf.keras.backend.sum(x, axis=1), 
        ...
        tw_hidden = target_word_hidden(non_linearity, target_role, n_word_vocab, n_role_vocab, GlorotUniform(), n_hidden, n_hidden, 
            using_dropout=using_dropout, dropout_rate=dropout_rate)

        # target role hidden layer
        tr_hidden = target_role_hidden(non_linearity, target_word, n_word_vocab, n_role_vocab, GlorotUniform(), n_hidden, n_hidden, 
            using_dropout=using_dropout, dropout_rate=dropout_rate)
