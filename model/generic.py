...
####### import path from parent directory
import os, sys
...
class GenericModel(tf.keras.Model):
    ...
    def __init__(self, n_word_vocab, n_role_vocab, n_factors_emb, n_hidden, word_vocabulary, role_vocabulary, 
        ...
        super(GenericModel, self).__init__(n_word_vocab, n_role_vocab, n_factors_emb, n_hidden, word_vocabulary, role_vocabulary, 
              unk_word_id, unk_role_id, missing_word_id, using_dropout, dropout_rate, optimizer, loss, metrics)
...
#model = GenericModel(n_word_vocab = 50000, n_role_vocab = 50, n_factors_emb = 100, n_hidden = 64, word_vocabulary = {"this":1,"is":2,"test":3}, role_vocabulary = {"arg0":1,"prd":2,"arg1":3}, 
#        unk_word_id = 0, unk_role_id = 0, missing_word_id = 0, using_dropout = True, dropout_rate = 0.2, optimizer = "adam", loss = "cls", metrics="acc")
#print("here")