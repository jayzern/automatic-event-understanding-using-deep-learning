...
import roles
ROLES_CLS = roles.Roles2Args3Mods   # roles.Roles3Args3Mods #Roles2Args3Mods
...
OUTPUT_PATH = '/home/ymarton/data/rw-eng/ukwac-proc-out-preproc4DL-20190929/exp9_%s-%d-%d-%s-%s-%s/' % (NUM_TRAIN_FILES, len(NUM_DEV_FILES), len(NUM_TEST_FILES), ROLES_CLS.__name__, ("FrAn" if USE_FRAMES_AND_ANIM else "NoFrAn"), CODE_VER)
