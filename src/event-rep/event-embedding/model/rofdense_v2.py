...
class MTRFv4ResDense_v2(GenericModel):
    ...
    def __init__(self, n_word_vocab=50001, n_role_vocab=7, n_factors_emb=300, n_hidden=300, word_vocabulary=None, role_vocabulary=None, 
        ...
        super(MTRFv4ResDense_v2, self).__init__(n_word_vocab, n_role_vocab, n_factors_emb, n_hidden, word_vocabulary, role_vocabulary, 
        ...
        # Instead of taking the mean, we flatten the vectors
