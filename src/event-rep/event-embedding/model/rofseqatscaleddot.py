...
class MTRFv4RofSeqAtScaledDot(GenericModel):
    ...
    def __init__(self, n_word_vocab=50001, n_role_vocab=7, n_factors_emb=300, n_hidden=300, word_vocabulary=None, role_vocabulary=None, 
        ...
        super(MTRFv4RofSeqAtScaledDot, self).__init__(n_word_vocab, n_role_vocab, n_factors_emb, n_hidden, word_vocabulary, role_vocabulary, 
        ...
        attention = K.sum(activations * activations, axis=-1, keepdims=True)

        attention = Lambda(lambda x: x/np.sqrt(n_factors_emb))(attention)
