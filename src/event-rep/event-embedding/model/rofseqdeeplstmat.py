...
class MTRFv4RofSeqDeepLSTMAt(GenericModel):
    ...
    def __init__(self, n_word_vocab=50001, n_role_vocab=7, n_factors_emb=300, n_hidden=300, word_vocabulary=None, role_vocabulary=None, 
        ...
        rnn1 = LSTM(n_factors_emb, 
            input_shape=(input_length, n_factors_emb),
            return_sequences=True,
            name='rnn1')(residual_0)

        rnn2 = LSTM(n_factors_emb, 
            input_shape=(input_length, n_factors_emb),
            return_sequences=True,
            name='rnn2')(rnn1)
        ...
        # 256
        # 6
        # Tensor("residual_0/add:0", shape=(None, 6, 256), dtype=float32)
        ...
        # print("contextual emb output is")
        # print(context_embedding)
        # Tensor("rnn/PartitionedCall:0", shape=(None, 256), dtype=float32)
        # exit()
