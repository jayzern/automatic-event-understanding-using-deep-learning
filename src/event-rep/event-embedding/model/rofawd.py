...
from tensorflow.keras.layers import Input, Embedding, Dropout, Dense, Lambda, Multiply, Masking, Concatenate, Flatten
...
class MTRFv4WD(GenericModel):
    ...
    def __init__(self, n_word_vocab=50001, n_role_vocab=7, n_factors_emb=300, n_hidden=300, word_vocabulary=None, role_vocabulary=None, 
        ...
        tw_hidden = target_word_hidden(non_linearity_2, target_role, n_word_vocab, n_role_vocab, glorot_uniform(), n_hidden, n_hidden, 
