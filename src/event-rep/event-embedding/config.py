...
### (Team2-change) For Every Sequential Model PLEASE ADD THEM HERE!!!!
'''
...
"MTRFv4RofSeqAtScaledDot", "MTRFv4RofSeqAtGen", "MTRFv4RofSeqConv", "MTRFv4RofSeqTargAt", "MTRFv4RofSeqTargAtLeakyReLU"]
